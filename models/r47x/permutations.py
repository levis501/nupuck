...
'/Users/steven/Development/nupic/build/release/lib/python2.7/site-packages/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'lpos': PermuteEncoder(fieldName='lpos', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(22, 521), ),
  u'lwidth': PermuteEncoder(fieldName='lwidth', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(22, 521), ),
  u'rpos': PermuteEncoder(fieldName='rpos', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(classifierOnly=True, fieldname='rpos', w=21, clipInput=True, type='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
  u'rwidth': PermuteEncoder(fieldName='rwidth', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[40, 70, 100\]:window=1000:field=rpos")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[40, 70, 100\]:window=1000:field=rpos"
