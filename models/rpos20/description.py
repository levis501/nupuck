...
control = {
 ...
 u'predictionSteps': [20]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'rpos', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [20], 'errorMetric': 'aae'}),
    MetricSpec(field=u'rpos', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [20], 'errorMetric': 'altMAPE'})
  ],
