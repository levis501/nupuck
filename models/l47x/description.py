...
control = {
 ...
 u'predictedField': u'lpos',
 u'predictionSteps': [40, 70, 100]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'lpos', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [40, 70, 100], 'errorMetric': 'aae'}),
    MetricSpec(field=u'lpos', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [40, 70, 100], 'errorMetric': 'altMAPE'})
  ],
