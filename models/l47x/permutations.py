...
'/home/steven/Development/nupic/build/release/lib/python2.7/site-packages/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  '_classifierInput': dict(classifierOnly=True, fieldname='lpos', w=21, clipInput=True, type='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[40, 70, 100\]:window=1000:field=lpos")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[40, 70, 100\]:window=1000:field=lpos"
