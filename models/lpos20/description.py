...
control = {
 ...
 u'predictionSteps': [20]},
  ...
  'metrics':[
    MetricSpec(field=u'lpos', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [20], 'errorMetric': 'aae'}),
    MetricSpec(field=u'lpos', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [20], 'errorMetric': 'altMAPE'})
  ],
