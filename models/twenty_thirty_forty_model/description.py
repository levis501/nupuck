...
control = {
 ...
 u'predictionSteps': [30, 40, 50]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'rpos', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [30, 40, 50], 'errorMetric': 'aae'}),
    MetricSpec(field=u'rpos', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [30, 40, 50], 'errorMetric': 'altMAPE'})
  ],
